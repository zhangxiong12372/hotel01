...
<div style="display: none;margin-top: 20px;" id="exitInRoomInfoDiv">
    <form class="layui-form layui-form-pane" action="" lay-filter="exitInRoomInfoForm" style="margin-left: 20px;">
        <!--入住信息id,被隐藏-->
        ...
        <div class="layui-form-item layui-form-text" style="width: 600px;">
            <label class="layui-form-label" style="text-align: center">退房备注</label>
            <div class="layui-input-block">
        ...
        <div class="layui-form-item">
            ...
            <span style="font-size: 30px;color: red" id="zprice"></span>元
        </div>
